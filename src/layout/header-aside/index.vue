    ...
    <div class="cs-layout-header-aside-content" flex="dir:top">
      ...
      <div class="cs-theme-header" :style="{'opacity': this.searchActive ? 0.5 : 1}" flex-box="0" flex>
        <div class="logo-group" :style="{'width': asideCollapse ? asideWidthCollapse : asideWidth}" flex-box="0">
          <a target="blank" href="//www.istrong.cn/">
        ...
        <div class="toggle-aside-btn" @click="handleToggleAside" flex-box="0" v-if="isShowAside">
...
export default {
  ...
  computed: {
    ...mapState('istrong', {
      ...
      isShowAside: state => state.menu.isShowAside,
